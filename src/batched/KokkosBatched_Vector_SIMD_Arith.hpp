...
#pragma vector always
    ...
    inline
    static
    KOKKOSKERNELS_SIMD_ARITH_RETURN_TYPE(Kokkos::complex<double>,1)
    operator + (const Vector<SIMD<Kokkos::complex<double> >,1> &a, const Vector<SIMD<Kokkos::complex<double> >,1> &b) {
      return vaddq_f64(a, b);
    }
#endif
#endif
